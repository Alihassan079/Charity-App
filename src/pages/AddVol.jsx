...
const AddVol =()=>{
    ...
    const handleSubmit = (e) => {
        ...
        if(firstName && lastName && des && email && nic && phone){
            ...
            <div className="col-12 col-md-12 col-sm-12 col-12" >
                <div class="row">
                    ...
                    <div className="col-3 col-md-3 col-sm-3 col-3" >
                        <MDBBtn className='btn-dashboard' color="secondary" href={"/all_vols"} style={{ float: 'left' }}> <i class="fas fa-home"></i> &nbsp;Volunteer Dashboard</MDBBtn>
                    </div> 
                </div>
            </div>  
            ...
            <div style={{ margin: "auto", padding: "15px", maxWidth: "750px", alignContent: "center", marginTop: "10px", }}>
                <MDBCard alignment="center">
                    <MDBCardHeader style={{backgroundColor:'white'}}>
                        <h4 style={{ fontWeight: 'bold', color:'black' }}>{id? "Update Volunteer" : "Register Volunteer"}</h4>
                    </MDBCardHeader>
                    <MDBCardBody className='card-body-main'>
                        <MDBValidation className='add_form' onSubmit={handleSubmit} noValidate>
                            ...
                            <div className="col-12 mt-4">
                                <MDBBtn className="btn btn-success submit-button-web" style={{width:"15%"}}>{id? "Update": "Submit"}</MDBBtn>
                                &nbsp; &nbsp; &nbsp; &nbsp;
                                <Link to="/all_donors">
                                <MDBBtn className="btn btn-primary btn-cancel-donor">
                                    Cancel
                                </MDBBtn>
                                </Link>
                            </div>
