      ...
      <div className="col-12 col-md-12 col-sm-12 col-12">
        <div class="row">
          ...
          <div className="col-3 col-md-3 col-sm-3 col-3">
            ...
            >
              {" "}
              <i class="fas fa-home"></i> &nbsp;Sponsor Dashboard
            </MDBBtn>
          </div>
        </div>
      </div>
      ...
      >
        <MDBCard alignment="center">
          <MDBCardHeader style={{backgroundColor:'white'}}>
            <h4 className="dashboard-main-btn" style={{ fontWeight: "bold", color:'black' }}>
              {id ? "Update Sponsor" : "Register Sponsor"}
            </h4>
          </MDBCardHeader>
          <MDBCardBody className="card-body-main">
            ...
            >
              ...
              <div className="col-12 mt-4">
                <MDBBtn className="btn submit-button-web">
                  {id ? "Update" : "Submit"}
                </MDBBtn>
                &nbsp; &nbsp; &nbsp; &nbsp;
                <Link to="/all_donors">
