...
import { getAllPayments } from '../redux/features/payment';
                            ...
                            {allData && allData.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;
                                        <MDBBtn color="info" href={item.type === "online-payment" ? 'https://dashboard.stripe.com/test/payments' :`/donation/${item._id}`}><i className="fas fa-eye"></i>&nbsp;</MDBBtn>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
