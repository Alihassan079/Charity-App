...
const API = axios.create({
 ...
 export const forgetPassword = (email)=> API.post("/users/forgetPassword", {email: email});
...
// user requests
export const createUserRequests = (data)=> API.post("/users/createUserRequest", data);
export const getUserRequests = (data)=> API.post("/users/getUserRequests");
export const deleteUserRequest = (id)=> API.delete(`/users/${id}`);

//  payments
export const makePayment = (data)=> API.post("/payment/makePayment", data);
export const getAllPayments = ()=> API.get("/payment/allpayments");
